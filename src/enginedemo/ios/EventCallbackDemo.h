...
@interface EventCallbackDemo : DemoBase 
{
    kwlEventDefinitionHandle m_eventDefinitionHandle;
    kwlEventHandle m_eventInstanceHandle;
    kwlWaveBankHandle m_waveBankHandle;
    UIView* oneshotStoppedIndicator;
    UIView* instanceStoppedIndicator;
}

@property (nonatomic, retain) IBOutlet UIView* oneshotStoppedIndicator;
@property (nonatomic, retain) IBOutlet UIView* instanceStoppedIndicator;
