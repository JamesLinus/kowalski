...
#ifndef KWL_PROJECT_DATA_BINARY_H
#define KWL_PROJECT_DATA_BINARY_H
...
extern "C"
{
     ...
     *
     */
    void kwlProjectDataBinary_load(kwlProjectDataBinary* bin, const char* path);
...
#endif /*KWL_PROJECT_DATA_BINARY_H*/
