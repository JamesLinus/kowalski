...
#define KWL_XML_ATTR_AUDIO_DATA_REFERENCE_LOOP "loop"
...
#define KWL_XML_ATTR_EVENT_OUTER_GAIN "outerConeGain"
...
#define KWL_XML_ATTR_EVENT_RETRIGGER_MODE "retriggerMode"
#define KWL_XML_ATTR_EVENT_INSTANCE_STEALING_MODE "instanceStealingMode"
